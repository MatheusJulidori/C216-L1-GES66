...
API_BASE_URL = os.getenv("API_BASE_URL" , "http://backend:5000/api/v1/professor")
API_DATABASE_RESET = os.getenv("API_DATABASE_RESET" , "http://backend:5000/api/v1/database/reset") 
